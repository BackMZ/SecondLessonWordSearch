...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (resultSearch == null) { // если в поэме ничего не найдено, то
                output.setText("Строк заданной длины в поэме не найдено");
            } else {
    ...
    private String searchMapPoem(String search, Map<Integer, String> map) {
        ...
        for (Integer key: map.keySet()) { // перебор мап по ключам
            try {
                if(map.get(key).length() == Integer.parseInt(search)) { // если в строке с ключом key имеется фраза поиска, то
                    count++; // счётчик найденных фраз
                    result = result + "\n\n" + map.get(key); // формирование строки найденных в поэме подстрок
                }
            } catch (Exception ex) {
                return "Введите число для начала поиска";
            }
        }
        ...
        if (count == 0) {
            ...
            return "В поэме найдено " + count + " строк(и) заданной длины:" + result; // вывод количества найденных в поэме фраз и подстрок поэмы, где они были найдены
        }
    }
